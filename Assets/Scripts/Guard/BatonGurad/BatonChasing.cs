...
{
    public class BatonChasing : BatonGuardState
    {
        private Transform _player;
        public BatonChasing(BatonGuard guard, Transform player) : base(guard)
        {
        ...
        public void OnTick()
        {
            ...
            else
            {
                ...
                {
                    _guard.StateManager.SwitchStateTo(new BatonCatch(_guard, _player));
                    return;
                }
            }
        ...
        {
            _guard.StateManager.SwitchStateTo(new BatonSearching(_guard, _player));
        }
    }
}
