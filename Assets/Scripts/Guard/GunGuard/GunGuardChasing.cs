...
namespace NPC.Guard
{
    public class GunGuardChasing : GunGuardState
    {
        private Transform _player;
        public GunGuardChasing(GunGuard guard, Transform player) : base(guard)
        {
        ...
        public void OnTick()
        {
            ...
            else
            {
                ...
                {
                    _guard.StateManager.SwitchStateTo(new GunGuardShooting(_guard, _player));
                    return;
                }
            }
